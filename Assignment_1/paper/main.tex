...
%\begin{figure}[H]
%	\centering
%	\subfigure[$\alpha=\beta=1$]{\includegraphics[width=0.65\textwidth]{Figures/plot2_2_a1.png}}\quad
%	\subfigure[$\alpha=10 \beta=1$]{\includegrapchics[width=0.65 \textwidth]{Figures/plot2_2_a2.png}}
%	\caption{\label{fig:distribuition}}
%\end{figure}
